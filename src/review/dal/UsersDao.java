...
public class UsersDao {
	...
	/**
	 * Get the Users record by fetching it from your MySQL instance. This runs a
	 * SELECT statement and returns a single Users instance.
	 * 
	 * @throws SQLException
	 */
	public Users getUserByUserName(String userName) throws SQLException {
		String selectUser = 
			"SELECT UserName,Password,FirstName,LastName,Email,Phone FROM Users WHERE UserName=?;";
		Connection connection = null;
	...
	public Users delete(Users user) throws SQLException {
		// Note: Reservations has a fk constraint on Users with the reference
		// option ON DELETE CASCADE.
		// So this delete operation will delete all the referencing Reservations.
		// Note: Recommendations has a fk constraint on Users with the reference
		// option ON DELETE CASCADE.
